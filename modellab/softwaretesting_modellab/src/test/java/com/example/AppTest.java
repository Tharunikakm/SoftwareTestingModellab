...
public class AppTest {
    ...
    public static void startTest() {
        ExtentSparkReporter spark = new ExtentSparkReporter(
                "E:\\softwaretesting_modellab\\report.html");
    ...
    public void testCase() throws Exception {
        ...
        FileInputStream fi = new FileInputStream("E:\\dbankdemo.xlsx");
        ...
        String email = r.getCell(6).getStringCellValue();
        ...
        String path = "E:\\softwaretesting_modellab\\sample.png";
